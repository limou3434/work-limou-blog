...
百炼是一个可视化平台，同时服务于技术和非技术同学，使用更简单，更上层；而 [阿里云灵积](https://www.aliyun.com/product/dashscope) 旨在通过灵活、易用的 **模型 API 接口**，让开发者能够快速调用丰富的大模型能力，面向技术开发同学，更底层。后续我们通过编程来调用 AI 大模型，更多的是和灵积打交道。
